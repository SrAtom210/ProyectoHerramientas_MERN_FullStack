...
import { login, reset } from '../../features/authSlice'; // BIEN
import Spinner from './Spinner'; // Si no tienes Spinner, puedes borrar esta línea y la lógica de isLoading
...
function Login() {
    ...
    if (isLoading) {
        return <h1><Spinner /></h1>; // O usa <Spinner /> si lo tienes creado
    }
